...
app = Flask(__name__)
# Habilitamos CORS para que React/HTML se comuniquen sin problemas con Flask
CORS(app)
...
def ai_query():
    ...
    system_instruction = data.get('systemInstruction', 'Eres un asistente experto en ventas y búsqueda de datos comerciales en Argentina.')
