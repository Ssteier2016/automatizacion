...
import { Leaf, Search, Wand2, Mail, MessageCircle, ChevronRight, Check, Facebook, Instagram } from 'lucide-react';
...
const App = () => {
  ...
  const buscar = async () => {
    ...
    try {
      ...
      if (data.success) {
        // Inicializamos los leads con estado "Pendiente"
        setLeads(data.leads.map(l => ({ ...l, status: 'Pendiente' })));
        // Pre-seleccionamos automáticamente los que tienen contacto
  ...
  return (
    <div className="bg-[#020617] text-slate-200 font-sans min-h-screen flex flex-col lg:flex-row overflow-y-auto">
      <div className="flex flex-col lg:flex-row w-full min-h-screen">
        ...
        <aside className="lg:w-96 bg-[#0b1120] border-r border-slate-800 p-6 space-y-6 flex flex-col shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[9px] text-slate-500 font-bold uppercase tracking-widest">Automatización</p>
            </div>
          </div>
        ...
        <main className="flex-1 p-4 lg:p-8 flex flex-col min-h-screen overflow-y-auto">
                      ...
                      >
                        ...
                        <td className="px-6 py-4 text-center">
                          {lead.telefono ? (
                            ...
                            >
                              <MessageCircle size={12} /> {lead.telefono}
                            </button>
                          ) : '--'}
                        </td>
